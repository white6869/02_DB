...
-- 테이블에 이쓴 모든 컬럼에 대한 값을 INSERT 할 때 사용.
SELECT * FROM EMPLOYEE2;
...
--> SELECT 조회 결과의 데이터 타입, 컬럼개수가 INSERT 하려는 테이블의 컬럼과 일치해야함.
